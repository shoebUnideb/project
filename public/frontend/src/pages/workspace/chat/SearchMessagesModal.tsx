...
export function SearchMessagesModal({
  ...
  const pool: (WorkspaceChatMessage | WorkspaceDMMessage)[] = isDM
    ? (dmMessages as (WorkspaceChatMessage | WorkspaceDMMessage)[])
    : (messages as (WorkspaceChatMessage | WorkspaceDMMessage)[]);
